...
.auto-box-grid { display:grid; grid-template-columns:repeat(3,1fr); gap:1rem; margin-bottom:0.75rem; }
.auto-box-grid-wtax { display:grid; grid-template-columns:1fr; gap:1rem; margin-bottom:1.5rem; }
...
.auto-box-wtax { background:#fff7ed; border:2px solid #fed7aa; border-radius:10px; padding:12px 18px; display:flex; align-items:center; justify-content:space-between; }
.auto-box-wtax .auto-box-label { margin-bottom:0; color:#c2410c; }
.auto-box-wtax .auto-box-value { font-size:1.1rem; font-weight:800; color:#9a3412; }
.auto-box-wtax .auto-box-note  { font-size:0.68rem; color:#fb923c; }
</style>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:1.5rem;margin-bottom:1.5rem;">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="auto-box-grid-wtax">
                    <div class="auto-box-wtax">
                        <div>
                            <div class="auto-box-label">Withholding Tax</div>
                            <div class="auto-box-note">Computed separately — based on taxable income</div>
                        </div>
